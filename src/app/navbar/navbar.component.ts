...
import { faUser, faRepeat, faHeart, faCartPlus, faBars, faAngleDown} from '@fortawesome/free-solid-svg-icons';
...
export class NavBarComponent{
  constructor(library: FaIconLibrary) {
    ...
    library.addIcons(faUser,faRepeat,faHeart,faCartPlus,faBars,faAngleDown,farCircle,farSquare
